...
<html>
	...
	<body>
		...
		<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
		  ...
		  <!-- END SVG -->
		<main>
			<h1 class="visually-hidden">MI PRIMER HEADER</h1>
		</main>
		<div class="container">
			<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bootom">
				<a href="http://" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
					<svg class="bi me-2" width="40" height="32"><use xlink:href="#bootstrap"/></svg>
					<span class="fs-4">Mi prime header</span>
				</a>
